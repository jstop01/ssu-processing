public class Scene_328 extends BaseScene {
  ...
  public void setup() {
    ...
    // var 풀2 = objectFactory.create("compressedRes/images/objects/sorghum.png");
    // 풀2.setPosition(200, 300);
    // 풀2.setScale(0.5, 0.5);
    // drawManager.addDrawable(풀2);

    // var 풀3 = objectFactory.create("compressedRes/images/objects/sorghum.png");
    // 풀3.setPosition(400, 300);
    // 풀3.setScale(0.5, 0.5);
    // drawManager.addDrawable(풀3);

    // var 풀4 = objectFactory.create("compressedRes/images/objects/sorghum.png");
    // 풀4.setPosition(600, 300);
    // 풀4.setScale(0.5, 0.5);
    // drawManager.addDrawable(풀4);

    // var 풀5 = objectFactory.create("compressedRes/images/objects/sorghum.png");
